...
<aside x-show="sidebarOpen" x-transition:enter="transition ease-in-out duration-300 transform"
    ...
    x-data="{ activeLink: 'dashboard' }" style="display: none;">
    ...
    <nav class="mt-6 px-3 flex-1 overflow-y-auto pb-20">
        ...
        <a href="#" @click.prevent="activeLink = 'dashboard'"
            ...
            <svg class="h-6 w-6 text-white flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-width="2" d="M3 12l2-2 7-7 7 7" />
            </svg>
        ...
        <a href="#" @click.prevent="activeLink = 'documents'"
            class="flex items-center py-3 px-4 mb-2 rounded-lg
                  border-l-4 border-transparent
                  transition-all duration-200
                  hover:opacity-80"
            ...
            <svg class="h-6 w-6 text-white flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586l5.414 5.414" />
            </svg>
        ...
        <a href="#" @click.prevent="activeLink = 'upload'"
            class="flex items-center py-3 px-4 mb-2 rounded-lg
                  border-l-4 border-transparent
                  transition-all duration-200
                  hover:opacity-80"
            ...
            <svg class="h-6 w-6 text-white flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-width="2" d="M15 13l-3-3-3 3m3-3v12" />
            </svg>
        ...
        <a href="#" @click.prevent="activeLink = 'categories'"
            ...
            <svg class="h-6 w-6 text-white flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-width="2" d="M7 3h5l7 7-7 7H7L3 12V7a4 4 0 014-4z" />
            </svg>
        ...
        <a href="#" @click.prevent="activeLink = 'users'"
            ...
            <svg class="h-6 w-6 text-white flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-width="2" d="M12 4a4 4 0 110 8 4 4 0 010-8zm-8 16a6 6 0 0116 0" />
            </svg>
        ...
        <a href="#" @click.prevent="activeLink = 'reports'"
            class="flex items-center py-3 px-4 mb-2 rounded-lg
                  border-l-4 border-transparent
                  transition-all duration-200
                  hover:opacity-80"
            ...
            <svg class="h-6 w-6 text-white flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-width="2" d="M9 17V7m4 10V3m4 14V11" />
            </svg>
        ...
        <a href="#" @click.prevent="activeLink = 'settings'"
            class="flex items-center py-3 px-4 mb-2 rounded-lg
                  border-l-4 border-transparent
                  transition-all duration-200
                  hover:opacity-80"
            ...
            <svg class="h-6 w-6 text-white flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-width="2" d="M12 15a3 3 0 100-6" />
            </svg>
