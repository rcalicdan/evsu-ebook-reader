<div x-data="{ show: @entangle('show') }" x-show="show" x-cloak class="relative z-[9999]" aria-labelledby="modal-title"
            ...
            <div x-show="show" @click.away="$wire.closeModal()"
                ...
                <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div
                            class="mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full {{ $iconConfig['bg'] }} sm:mx-0 sm:h-10 sm:w-10">
                            <svg class="h-6 w-6 {{ $iconConfig['text'] }}" fill="none" viewBox="0 0 24 24"
                ...
                <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                    <button type="button" wire:click="confirm" wire:loading.attr="disabled"
                        class="inline-flex w-full justify-center rounded-md {{ $buttonConfig }} px-3 py-2 text-sm font-semibold text-white shadow-sm disabled:opacity-75 disabled:cursor-not-allowed sm:ml-3 sm:w-auto">
                        <span wire:loading.remove wire:target="confirm">{{ $confirmText }}</span>
                        <span wire:loading wire:target="confirm" class="inline-flex items-center">
                    ...
                    <button type="button" wire:click="closeModal" wire:loading.attr="disabled" wire:target="confirm"
