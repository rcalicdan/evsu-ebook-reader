<div class="space-y-8">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            ...
            <p class="text-sm text-gray-500">Add a new category to organize documents in the system.</p>
        </div>
    ...
    <form wire:submit.prevent="save">
        <x-form.card title="Category Information" description="Fill in the details to create a new category.">
            <x-slot:footer>
