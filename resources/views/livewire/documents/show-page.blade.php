        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <x-form.card>
                ...
                <div class="flex items-center gap-4 p-4 bg-gray-50 rounded-xl border border-gray-100">
                    ...
                    <!-- Preview Button — implementation excluded for now -->
                    <button type="button" disabled
                        class="inline-flex items-center gap-2 px-4 py-2 bg-university-red/10 text-university-red text-sm font-medium rounded-lg opacity-50 cursor-not-allowed">
